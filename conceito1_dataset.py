...
def create_dataset(path=r'C:\Users\efgom\OneDrive\Documentos\GitHub\breast-cancer-classification'):
    ...
    for i in tqdm.tqdm(range(0, extraPath.size)):
        ...
        procPathMasses = path + '/data/conceptl/conceito1_1/masses' + extraPath[i]
            ...
            if len(attributes[1])==1:  
                ...
                if lesion_type.find("MASS") != -1:
                    if lesion_type.find("CALCIFICATION") == -1:
                        ...
                        if attributes[0]=='7' or attributes[0]=='8':  #Agrupar round e oval numa única class
                            attributes[0]='0'
                        else:  #Restantes classificações noutra class
                            attributes[0]='1'
                        if attributes[1]=='1':  #Circunscribed como uma class
                            attributes[1]='0'
                        else: ##Restantes classificações noutra class
                            attributes[1]='1'
